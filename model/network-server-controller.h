...
#ifndef NETWORK_SERVER_CONTROLLER_H
#define NETWORK_SERVER_CONTROLLER_H
 ...
 */
  class NetworkServerController : public Object
{
public:
  static TypeId GetTypeId (void);

  NetworkServerController();
  virtual ~NetworkServerController();
...
#endif /* NETWORK_SERVER_CONTROLLER_H */
