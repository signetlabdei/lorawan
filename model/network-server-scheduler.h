...
#ifndef NETWORK_SERVER_SCHEDULER_H
#define NETWORK_SERVER_SCHEDULER_H
 ...
 */
  class NetworkServerScheduler : public Object
{
public:
  static TypeId GetTypeId (void);

  NetworkServerScheduler();
  virtual ~NetworkServerScheduler();
...
#endif /* NETWORK_SERVER_SCHEDULER_H */
