...
main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("MobileNodeProbability", "Probability of a node being a mobile node",
                mobileNodeProbability);
  cmd.AddValue ("sideLength", "Length of the side of the rectangle nodes will be placed in",
                sideLength);
  ...
  mobilityEd.SetMobilityModel (
      ...
      RectangleValue (Rectangle (-sideLength, sideLength, -sideLength, sideLength)), "Distance",
      DoubleValue (1000), "Speed",
      PointerValue (CreateObjectWithAttributes<UniformRandomVariable> (
          "Min", DoubleValue (minSpeed), "Max", DoubleValue (maxSpeed))));
